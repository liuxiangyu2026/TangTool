...
import { Binary, Braces, Fingerprint, GitCompareArrows, FileSpreadsheet, FileText, KeyRound, Link2 } from "lucide-vue-next";
const menuGroups = [
  {
    label: "JSON",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "MD5", icon: Fingerprint, path: "/md5" },
      { label: "Base64", icon: Binary, path: "/base64" },
    ]
  },
];
</script>
