...
- 文档组件版本1.0.0、协议1和下载版本v0.1.2由 `sidecar/runtime.json` 统一定义。Rust、文档页和 Windows 安装器均使用此配置；修改后需重建主程序及组件。健康检查20秒/64 KiB，转换180秒/16 MiB；只有匹配版本/架构且自检成功才启用转换，页面提供安装包和重新检测，无需重启。
